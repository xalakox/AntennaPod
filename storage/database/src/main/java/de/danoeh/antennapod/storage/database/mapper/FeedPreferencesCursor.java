...
public class FeedPreferencesCursor extends CursorWrapper {
    ...
    private final int indexNewestEpisodesPerFeed;
    ...
    public FeedPreferencesCursor(Cursor cursor) {
        ...
        indexNewestEpisodesPerFeed = cursor.getColumnIndexOrThrow(PodDBAdapter.KEY_NEWEST_EPISODES_PER_FEED);
    ...
    public FeedPreferences getFeedPreferences() {
        ...
        return new FeedPreferences(
                ...
                FeedPreferences.NewestEpisodesPerFeed.fromCode(getInt(indexNewestEpisodesPerFeed)));
    }
}
